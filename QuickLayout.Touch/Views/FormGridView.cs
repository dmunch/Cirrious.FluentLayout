...
namespace QuickLayout.Touch.Views
{
    ...
    public class FormGridView : MvxViewController
    {
        ...
        public override void ViewDidLoad()
        {
			...
			var equalWeightRowTemplate = new RowTemplate<UIView>()
                {
                    HInterspacing = 12f,
                    LeftMargin = 6f,
                    RightMargin = 24f
                };
			var addressRowTemplate = new RowTemplate<UIView>
                {
                    HInterspacing = 12f,
                    LeftMargin = 6f,
                    RightMargin = 24f
			...
			var townAndZipRowTemplate = new RowTemplate<UIView>()
            {
                HInterspacing = 12f,
                LeftMargin = 6f,
                RightMargin = 24f
			...
			View.AddConstraints(
                rowSet.Generate(View,
					new Row<UIView>(equalWeightRowTemplate, _forceTheWidthView),
					new Row<UIView>(equalWeightRowTemplate, fNameLabel, sNameLabel),
					new Row<UIView>(equalWeightRowTemplate, fNameField, sNameField),
					new Row<UIView>(addressRowTemplate, numberLabel, streetLabel),
					new Row<UIView>(addressRowTemplate, numberField, streetField),
					new Row<UIView>(townAndZipRowTemplate, townLabel, zipLabel),
					new Row<UIView>(townAndZipRowTemplate, townField, zipField),
					new Row<UIView>(equalWeightRowTemplate, _debugLabel)
                ));
